...
public class NotaController {
	...
	public String guardar(@RequestParam Integer actividad, @RequestParam Double nota, @RequestParam String observaciones) {
	...
	public String modificar(@RequestParam Integer actividad, @RequestParam Integer id_nota, @RequestParam Double nota, @RequestParam String observaciones) {
		Nota n =new Nota();
		Actividad a=erActividad.findById(actividad).get();
		n.setActividad(a);
