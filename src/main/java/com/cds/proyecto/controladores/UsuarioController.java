...
public class UsuarioController {
	...
	public String guardar(@RequestParam String nombre, @RequestParam String apellido, @RequestParam String usuario, @RequestParam String password, @RequestParam String clave, @RequestParam Integer rol) {
		...
		if(password.equals(clave)) {
			...
			//System.out.println("Error: La clave no es igual "+clave+" "+password); 
